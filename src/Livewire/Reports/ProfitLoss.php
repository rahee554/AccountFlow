    ...
    private function generateReportData()
    {
        ...
        $categories = Category::with('parent')
            ...
            ->map(function ($category) use ($categoryTotals) {
                ...
                $category->setAttribute('total_amount', $categoryData ? (float) $categoryData->total_amount : 0);
                $category->setAttribute('transaction_count', $categoryData ? $categoryData->transaction_count : 0);
