...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        // * --------------- Accounts ---------------*//
        $this->createIfMissing('accounts', function (Blueprint $table) {
            $table->id();
            $table->string('name');
        ...
        // * --------------- Payment Methods ---------------*//
        $this->createIfMissing('ac_payment_methods', function (Blueprint $table) {
            $table->id();
        ...
        // * --------------- Categories ---------------*//
        $this->createIfMissing('ac_categories', function (Blueprint $table) {
            $table->id();
        ...
        $this->createIfMissing('ac_transactions', function (Blueprint $table) {
            $table->id();
        ...
        // * --------------- Equity Partners ---------------*//
        $this->createIfMissing('ac_equity_partners', function (Blueprint $table) {
            $table->id();
        ...
        // * --------------- Equity Transactions ---------------*//
        $this->createIfMissing('ac_equity_trx', function (Blueprint $table) {
            $table->id();
        ...
        $this->createIfMissing('ac_assets', function (Blueprint $table) {
            $table->id();
            $table->string('name');
            $table->text('description')->nullable();
        ...
        $this->createIfMissing('ac_assets_trx', function (Blueprint $table) {
            $table->id();
        ...
        // * --------------- Planned Payments ---------------*//
        $this->createIfMissing('ac_planned_payments', function (Blueprint $table) {
            $table->id();
            $table->string('name');
        ...
        $this->createIfMissing('ac_planned_payment_trx', function (Blueprint $table) {
            $table->id();
        ...
        // * --------------- Purchases ---------------*//
        $this->createIfMissing('ac_purchases', function (Blueprint $table) {
            $table->id();
            $table->string('unique_id')->unique();
            $table->string('name');
            $table->text('description')->nullable();
        ...
        $this->createIfMissing('ac_purchase_trx', function (Blueprint $table) {
            $table->id();
            $table->string('unique_id')->unique();
        ...
        // * --------------- Settings ---------------*//
        $this->createIfMissing('ac_settings', function (Blueprint $table) {
            $table->id();
            $table->string('name')->nullable();
        ...
        // * --------------- Loans ---------------*//
        $this->createIfMissing('ac_loan_partners', function (Blueprint $table) {
            $table->id();
            $table->string('name');
        ...
        $this->createIfMissing('ac_loans', function (Blueprint $table) {
            $table->id();
        ...
        $this->createIfMissing('ac_loan_trx', function (Blueprint $table) {
            $table->id();
            $table->string('unique_id')->unique();
        ...
        // * --------------- Transfers ---------------*//
        $this->createIfMissing('ac_transfers', function (Blueprint $table) {
            $table->id();
        ...
        $this->createIfMissing('ac_user_wallets', function (Blueprint $table) {
            $table->id();
        ...
        $this->createIfMissing('ac_user_transfers', function (Blueprint $table) {
            $table->id();
        ...
        // * --------------- Budgets ---------------*//
        $this->createIfMissing('ac_budgets', function (Blueprint $table) {
            $table->id();
            $table->foreignId('account_id')->nullable()->constrained('accounts');
            $table->foreignId('category_id')->nullable()->constrained('ac_categories');
        ...
        // * --------------- Audit Trail ---------------*//
        $this->createIfMissing('ac_audit_trail', function (Blueprint $table) {
            $table->id();
        ...
        $this->createIfMissing('ac_trx_templates', function (Blueprint $table) {
            $table->id();
    ...
    public function down(): void
    {
        ...
        Schema::dropIfExists('ac_planned_payment_trx');
     ...
     *
     * AccountFlow may be installed alongside tables an application already owns
     * (`accounts` in particular is not prefixed), and re-running this migration
     * against a populated database must never drop or rebuild live financial
     * data. Every table below is therefore created only when absent; existing
     * tables and their rows are left untouched.
     */
